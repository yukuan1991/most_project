...
void most_analysis::init_conn()
{
    ...
    connect(this, &most_analysis::cut, ui->widget_data, &data_widget::on_cut);
    connect(this, &most_analysis::copy, ui->widget_data, &data_widget::on_copy);
    connect(this, &most_analysis::paste, ui->widget_data, &data_widget::on_paste);
    connect(this, &most_analysis::del, ui->widget_data, &data_widget::on_del);
